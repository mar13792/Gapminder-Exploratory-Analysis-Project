...
<!--
## Comparing Former Yugoslavian Countries
...
--> 
<!--
## Just for fun... Comparing Countries in Epcot
Disney World's Epcot theme park features 'pavillions' that highlight the cultures of 11 countries:
...
Characteristics of these countries can be compared using the gapminder dataset. 

```{r, echo=FALSE}
epcot_2005<- gapminder %>% 
  mutate(pop_million=pop/1000000) %>%
  filter(year=='2005' & country=='Canada' | country=='United Kingdom' | country=='France' | country=='Morocco' | country=='Japan' | country=='United States' | country=='Italy' | country=='Germany' | country=='China' | country=='Norway' | country=='Mexico')
ggplot(data = epcot_2005) +
  geom_smooth(mapping = aes(x = year, y = gdpPercap, color = country)) +
  facet_wrap(~ country) +
  theme(legend.position="none") +
  xlab("Year") + 
  ylab("GDP per capita") +
  ggtitle("GDP per capita in Epcot countries \n2005")+
  theme(plot.title = element_text(hjust = 0.5))
```
--> 
